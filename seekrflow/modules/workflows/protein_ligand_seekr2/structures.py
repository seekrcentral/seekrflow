"""
modules/workflows/protein_ligand_seekr2/structures.py
...
@define
class Protein_ligand_seekr2_workflow:
    """
    Settings for the protein-ligand seekr2 workflow.
    """
    type: typing.Literal["protein_ligand_seekr2"] = "protein_ligand_seekr2"
    ...
    def write_component_pqr_files(
        ...
        receptor_tmp_filename = os.path.join(param_directory, "receptor_tmp.pdb")
        fixer_settings.run(not_ligand_tmp_filename, receptor_tmp_filename)
        full_receptor_pqr_filename = os.path.join(param_directory, "receptor.pqr")
        receptor_tmp_structure = parmed.load_file(
            receptor_tmp_filename)
        receptor = base.choose_only_receptor_atoms(parmed_complex, receptor_tmp_structure)
